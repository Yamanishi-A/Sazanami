        ...
        <div class="bg-gradient-to-br from-secondary/40 via-white to-accent/30 rounded-3xl p-8 shadow-lg border border-border mb-8">
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex-shrink-0 flex gap-3">
                    <a href="/users/settings" class="p-4 bg-white hover:bg-secondary/50 text-primary rounded-full shadow-md hover:shadow-lg transition-all flex items-center justify-center" aria-label="Settings">
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" data-bind="foreach: playlists">
                <div class="bg-white rounded-2xl p-4 shadow-md hover:shadow-xl border border-border transition-all cursor-pointer">
                    <a data-bind="attr: { href: '/playlists/' + id }" class="block relative overflow-hidden rounded-xl mb-4 aspect-square bg-gray-100 group">
                    ...
                    <div class="flex items-start justify-between gap-3">
                        <a data-bind="attr: { href: '/playlists/' + id }" class="flex-1 min-w-0 block">
...
<script>
    ...
    function UserPageViewModel() {
        ...
        self.removeCoverImage = function() {
            ...
            let fileInput = document.getElementById('cover-image-upload');
